...
const skillCategories = {
    technical: {
        ...
        icon: CodepenIcon,
        description: "Web Development and Creative Design Skills",
        languages: [
            "HTML",
            "CSS",
            "JavaScript",
        ...
        tools: ["Visual Studio Code","Microsoft Azure"]
    },
    marketing: {
        title: "Marketing & Management",
        icon: WebhookIcon,
        description: "Digital Marketing and Content Management",
        languages: [
    ...
    analysis: {
        title: "Analysis & Finance",
        icon: ActivityIcon,
        description: "Data Analysis and Financial Skills",
        languages: [
            "Data Analysis",
            "Power BI",
        ...
        tools: ["Power BI", "Excel", "Financial Analysis Tools"]
    },
    soft: {
        title: "Soft Skills",
        icon: MobileIcon,
        ...
        tools: ["Project Management Tools", "Team Collaboration Platforms"]
    }
};
