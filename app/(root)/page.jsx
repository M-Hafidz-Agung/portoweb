							...
							<div className="mx-auto container grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden md:px-20">
								<motion.div
									...
									<motion.p
										...
										Hi! I&rsquo;am Hafidz a Digital Business student with hands-on experience in creative project management and digital marketing.
										 Successfully achieved 1000+ listeners on music streaming platforms and managed events with 100+ participants.
										 Combines technical, analytical, and creative skills to support effective digital business strategy implementation.
									</motion.p>
									<motion.div
							...
							<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
								...
								<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
									...
									<motion.p
										...
										<a href="mailto:hafidagung1945@gmail.com?subject=Hello&body=Hello Hafidz,">
											hafidagung1945@gmail.com
										</a>
									</motion.p>
									{/* icons */}
									<div className="flex justify-center items-center space-x-4">
										<motion.a
											href="mailto:hafidagung1945@gmail.com?subject=Hello&body=Hello Hafidz,"
										...
										<motion.a
											href="https://www.instagram.com/hafidagung_/"
											target="_blank"
											rel="noopener noreferrer"
											className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
